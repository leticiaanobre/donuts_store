export default function Footer () {
    ...
    return (
        <footer className="text-gray-500 w-full bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
                ...
                <div className="flex-1">
                    ...
                    >
                        ...
                        <div className="max-w-sm flex items-center border rounded-md p-1">
                            ...
                            />
                            <button
                                className="p-2.5 rounded-md text-white bg-blue-600 hover:bg-blue-500 transition-150 outline-none shadow-md focus:shadow-none sm:px-5"
                            >
                                Subscribe
                            </button>
                        </div>
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2022 Donutful All rights reserved.
                </div>
