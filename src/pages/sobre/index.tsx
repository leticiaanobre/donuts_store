            ...
            <div className="flex flex-col px-4 justify-center items-center gap-20 max-w-screen-xl mx-auto md:px-8">
                ...
                <div className="shadow-lg items-center rounded-lg gap-x-12 sm:px-4 md:px-0 lg:flex">
                    ...
                    <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                        ...
                        <a href="javascript:void(0)" className="inline-flex border border-blue-200 rounded-xl py-2 px-4 gap-x-1 items-center text-indigo-600 hover:text-indigo-500 duration-150 font-medium">
                            Explore more
